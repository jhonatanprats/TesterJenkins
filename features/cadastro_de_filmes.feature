...
Esquema do Cenario: Campos Obrigatórios
    O gestor de catálago tenta cadastrar um novo fime, mas esquece
    de preencher um dos campos que são orbigatórios, em seguida, o sistema
    ...
    @dup_movie
    Cenario: Duplicado
        O gestor e catálago tenta cadastrar um filme, porém o título
        já foi cadastrado em outro momentoe o sistema notifica o usuário
        informando que o título já existe

        Dado que "deadpool2" é um novo filme
        Mas esse filme já existe no catálago
        Quando eu faço o cadastro deste filme
